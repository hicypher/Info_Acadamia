...
class new_order : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        type_new.setText("NEW ORDER")
        back_new.setOnClickListener {
            Log.d("#999", "forget")
        ...
        Log.d("#999", "Out")
        mydB.collection("new_order").whereEqualTo("UserID", sPref.getString("UserID", "")).get()
            ...
            if (task.isSuccessful) {
                ...
                Log.d("#99", "Data set in class")
                    ...
                    manager = LinearLayoutManager(this@new_order)
                    recyclerView.layoutManager = manager

                    val recyclerAdapterItemInfo = RecyclerAdapterItemInfoo_new_order(datalist, this@new_order)
