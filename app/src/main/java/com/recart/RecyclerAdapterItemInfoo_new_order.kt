...
class RecyclerAdapterItemInfoo_new_order(internal var datalist: List<ItemInfo>, internal var context: Context) : RecyclerView.Adapter<RecyclerAdapterItemInfoo_new_order.View_Holder>() {
    internal  var myDB: FirebaseFirestore=FirebaseFirestore.getInstance()
    private var PRIVATE_MODE = 0
    private val PREF_NAME = "PrefExpiry"
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): View_Holder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.new_order_item_data_list, parent, false)
    ...
    inner class View_Holder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        init {
            this.item_name = view.findViewById<View>(R.id.item_data_list_item_name_new_order) as TextView
            this.shop_name = view.findViewById<View>(R.id.item_data_list_shop_name_new_order) as TextView
            this.prise = view.findViewById<View>(R.id.item_data_list_prise_new_order) as TextView
            this.quantity = view.findViewById<View>(R.id.item_data_list_quantity_new_order) as TextView
            this.food_image = view.findViewById<View>(R.id.item_data_list_food_image_new_order) as ImageView
            this.status = view.findViewById<View>(R.id.item_data_list_status_new_order) as TextView
