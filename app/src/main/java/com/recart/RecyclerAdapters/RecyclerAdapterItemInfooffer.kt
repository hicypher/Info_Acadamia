...
class RecyclerAdapterItemInfooffer(internal var datalist: List<ItemInfo>, internal var context: Context) : RecyclerView.Adapter<RecyclerAdapterItemInfooffer.View_Holder>() {
    internal  var myDB: FirebaseFirestore=FirebaseFirestore.getInstance()
    private var PRIVATE_MODE = 0
    private val PREF_NAME = "PrefExpiry"

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): View_Holder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.activity_item_data_list_offer, parent, false)
    ...
    override fun onBindViewHolder(holder: View_Holder, position: Int) {
        ...
        val preprise = datalist[position].preprise
...
//        val food_image = datalist[position].food_image
        ...
        holder.preprise.text = "₹"+preprise
            holder.preprise.setPaintFlags( Paint.STRIKE_THRU_TEXT_FLAG)
        var offprice= (preprise?.toInt()  )?.minus((prise?.toInt()!!))
           holder.type.text = type
        holder.offprise.text="-"+offprice.toString()+" off"
    ...
    inner class View_Holder(view: View) : RecyclerView.ViewHolder(view) {
       ...
       var type: TextView
       var  preprise:TextView
       var  offprise:TextView
       ...
       // internal var available: TextView
        ...
        init {
            ...
            this.preprise = view.findViewById<View>(R.id.item_data_list_preprise) as TextView
            this.offprise = view.findViewById<View>(R.id.item_data_list_offprise) as TextView
            this.type = view.findViewById<View>(R.id.typeoffer) as TextView
